...
<head>
  ...
  <title>CBC Management Account management table</title>
...
?>
              ...
              <h6 class="m-0 font-weight-bold text-primary">CBC Account Management</h6>
            <a class="btn btn-primary" href="addaccount.php" style="margin-left: 800px; margin-top: -10;">Add account</a></div>
          <div class="card-body">
...
while($row = mysqli_fetch_array($result)){
   ...
   echo"<td><a href=updateaccount.php?id=" . $row["id"] . ">update</a></td>";
    echo"<td><a href=deleteaccount.php?id=" . $row["id"] . ">delete</a></td>";
