...
<head>
  ...
  <title>CBC Management Bus Information Tables</title>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fas fa-table"></i>
              ...
              <?php
              // 2. Do a query
$query  = "SELECT bus_information.type AS bus_type, bus_information.number AS bus_number, driver.name AS driver_name, driver.level AS level, driver.age AS age, driver.experience AS experience ";
$query .= "FROM bus_information "; 
$query .= "JOIN driver ON driver.d_id = bus_information.d_id ";  
