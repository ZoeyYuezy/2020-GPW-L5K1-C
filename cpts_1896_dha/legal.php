...
<head>
    ...
    <body bgcolor=" LightCyan">      
        <h1 style="text-align:center">Legal Cases </h1>
        <hr/>
...
while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<td><a href='legalu.php?id=" . $row["id"] ."'>Update</a></td>";
    echo "</tr>";
...
?>
     ...
     <form action='lc.html' autocomplete="off" class='button'>
