      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="information.php"> <i class="icon-grid"></i>Employee Information </a></li>
...
// 2. Do a query
$query  = "SELECT id, name, gender, birth, position "; 
$query .= "FROM ei ";
...
while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<td><a href='sa.php?id=" . $row["id"] ."'>Salary</a></td>";
    echo "<td><a href='schedule.php?id=" . $row["id"] ."'>Schedule</a></td>";
    echo "<td><a href='updatee.php?id=" . $row["id"] ."'>Update</a></td>";
    echo "</tr>";
...
?>
     ...
     <form action='fe.html' autocomplete="off" class='button'>
