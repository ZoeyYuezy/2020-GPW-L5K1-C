            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="home.php" class="navbar-brand d-none d-sm-inline-block">
                  <div class="brand-text d-none d-lg-inline-block"><span>Chengdu Consultancy </span><strong> Law</strong></div>
                  <div class="brand-text d-none d-sm-inline-block d-lg-none"><strong>CCL</strong></div></a>
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                    ...
                    <li><a href="legal.php"> <i class="fa fa-bar-chart"></i>Legal Cases</a></li>
                    <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Business Information </a>
                      <li class="active"><ul id="exampledropdownDropdown" class="collapse list-unstyled ">
        ...
        <div class="content-inner">
          ...
          <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Base Information            </li>
            </ul>
          </div>
            <?php
...
// 2. Do a query
$query  = "SELECT id, name, address, registered, tax, legal "; 
$query .= "FROM bi ";
...
while ($row = mysqli_fetch_array($result)) {
    ...
    echo "<td>" , $row["tax"] . "</td>";
    echo "<td>" , $row["legal"] . "</td>";
    echo "<td><a href='bide.php?id=" . $row["id"] ."'>Delete</a></td>";
    echo "<td><a href='updatebi.php?id=" . $row["id"] ."'>Update</a></td>";
...
?>
     ...
     <form action='bi.html' autocomplete="off" class='button'>
