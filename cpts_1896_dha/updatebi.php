...
<form action="updatebi.php" method="post">
    <input type="hidden" name="id" value="<?php echo $row["id"]; ?>">
    Name: <input type="text" name="name" value="<?php echo $row["name"]; ?>"> <br/>
    Address: <input type="text" name="address" value="<?php echo $row["address"]; ?>"> <br/>
    Registered Date: <input type="date" name="registered" value="<?php echo $row["registered"]; ?>"> <br/>
    Tax Information: <input type="text" name="tax" value="<?php echo $row["tax"]; ?>"> <br/>
    Legal Representative: <input type="text" name="legal" value="<?php echo $row["legal"]; ?>"> <br/>
