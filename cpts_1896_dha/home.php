...
<html>
  ...
  <body>
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Law</h2>
            </div>
          </header>
              ...
              <div class="row">
                ...
                <div class="chart col-lg-3 col-12">
                  ...
                  <div class="bar-chart has-shadow bg-white">
                    <div class="title"><strong class="text-violet">95%</strong><br><small>Number of Legal Cases</small></div>
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6">
                  <div class="pie-chart-example card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Empolyee Case(wins)</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="col-lg-6">
                  <div class="pie-chart-example card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Empolyee Case(losts)</h3>
                    </div>
                    <div class="card-body">
    ...
    <script src="charts-home.php"></script>
    <!-- Main File-->
