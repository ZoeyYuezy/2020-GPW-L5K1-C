...
<!--[if (gt IE 10)|!(IE)]><!--> <html lang="en-US"> <!--<![endif]-->
		...
		<body>
                ...
                <div class="adress_wrap">
                    <img src="http://placehold.it/1600x370" alt=""/>
                    <div class="adress">
                        <h2>Location</h2>
                        <div>
                            <p class="first">69 South Park Avenue San Francisco, CA 14782 USA</p>

                            <p>Phone: (00) 123 456 789</p>
                            <p>Fax: (00) 987 654 321</p>
                            <p>Email: <a href="#">support@companyname.com</a></p>
                            <p>Web: <a href="#">www,companyname.com</a></p>
                        </div>
                    </div>
                </div>
                <!-- Contact Img -->
